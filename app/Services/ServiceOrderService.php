...
{
    public function listForTechnician(User $technician, int $perPage = 15, ?EnumServiceOrderStatus $status = null): LengthAwarePaginator
    {
        ...
        if ($status !== null) {
            $query->where('state', $status->value);
        }
